<template>
  <div>
    <div>
        ...
        <button class="btn btn-primary" type="button">All Customer</button> 
        </router-link>
    </div>
   <div class="card mb-5 mb-xl-8 mw-550px">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">Update Customer</span>
								...
								<form class="form" @submit.prevent="customerUpdate" enctype="multipart/form-data">
